  ...
  return (
    <main className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-100 max-w-3xl mx-auto">
              Master GitHub Actions for CI/CD automation with our comprehensive training program
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Watch this demo to get a preview of our GitHub Actions training program
            </p>
          </motion.div>
          <motion.div
          ...
          >
            <div className="relative aspect-video rounded-lg overflow-hidden shadow-xl">
              <iframe
                ...
                title="GitHub Actions Training Demo"
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive modules covering everything you need to master GitHub Actions
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Master GitHub Actions?</h2>
      ...
      <RegistrationForm
        ...
        courseName="Self-Paced GitHub Actions Training"
      />
    </main>
  );
} 